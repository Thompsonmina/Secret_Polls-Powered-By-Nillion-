...
async def main():
    ...
    new_secret = nillion.NadaValues(
        {
            "tc1": nillion.SecretInteger(5),
            "tc2": nillion.SecretInteger(3),
            "tc3": nillion.SecretInteger(3),
            "tc4": nillion.SecretInteger(6),
            "tc5": nillion.SecretInteger(11),
        }
    )
    ...
    print("about to enter compute loop")
